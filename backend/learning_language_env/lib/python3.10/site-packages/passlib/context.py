...
class CryptContext(object):
    ...
    # to restrict what the backend OR the config can use.

    # XXX: add wrap/unwrap callback hooks so backend can mutate hash format?
    ...
    def _get_policy(self):
        ...
        #
        # the code waits until backend accesses a specific policy object attribute
