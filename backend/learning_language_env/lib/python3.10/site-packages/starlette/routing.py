...
class BaseRoute:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        """
        A route may be used in isolation as a stand-alone ASGI backend.
...
class Mount(BaseRoute):
    def __init__(
        ...
        ), "Either 'backend=...', or 'routes=' must be specified"
...
class Router:
    ...
    def mount(
        ...
        backend = Starlette(routes=routes)
        """
